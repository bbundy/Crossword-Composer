...
from xwdevel.views import main_landing, member_request, thanks, print_cw, mobile_find, usegrid, ranked_words, definition, examples, print_cw_all, fill, auto_clue
from xwdevel.views import download_xpf, from_xpf, doc, newus, newcryptic, download_puz, from_puz, save, retrieve, solve, gridedit, clues, pub_words, list_words
admin.autodiscover()
